...
public class Login extends JFrame implements ActionListener {
	...
	public Login() {
		super("Lab1-Pair programming/ 2021130019 潘昶勋");
		...
		if (e.getSource() == b_submit) {
			...
			if (loginname.getText().equals("2021130019") && pwd.equals("0123456789")) {
				JLabel jlabel = new JLabel(
						"<html><body>1.Make sure GraphViz is installed on this computer<br><br>2.Please make sure GraphViz.DOT in the Java file.Change the path of exe to a valid path for this computer<br><br></body></html>");
